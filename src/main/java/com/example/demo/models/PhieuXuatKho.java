...
public class PhieuXuatKho {
	...
	public PhieuXuatKho(long id) {
		super();
		this.id = id;
	}
	public PhieuXuatKho(long id, String maphieu, String tenphieu, Date ngaytao, int isdelete) {
		super();
		this.id = id;
	...
	public PhieuXuatKho(long id, String maphieu, String tenphieu, Date ngaytao) {
		super();
		this.id = id;
		this.maphieu = maphieu;
		this.tenphieu = tenphieu;
